...
To test all the components of the system are working as intended, let's download a *Domain Worker* to run a *Hello World* example:
...
### You're All Set!
Finally, you're all set. You can clone more domain workers as above and access them with dispatch.
